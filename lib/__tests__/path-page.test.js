...
// Resolve mocked default export for both ESM interop (`{ default: fn }`) and plain CJS (`fn`).
const fetchRequestModule = require("../fetch-request");
const FetchRequestConstructor =
  fetchRequestModule.default ?? fetchRequestModule;
const { getServerSideProps } = require("../../pages/[...path]");

const { mockGetObject, mockIsResponseSuccess } =
  FetchRequestConstructor.__testMocks;
